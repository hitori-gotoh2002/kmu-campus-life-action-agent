...
def _llm_analyze(notice, parsed_doc, ctx: dict) -> AnalysisResult:
    ...
    sys_prompt = (
        ...
        "- 반드시 줄바꿈(\\n)으로 구분된 항목으로 쓴다. 각 항목은 '키워드: 핵심내용' 형식.\n"
        "- 각 항목은 50자 내외로 명확하게. 문장이 아니라 키워드 요약으로 쓴다.\n"
        "- 아래 '공모전·대회 / 대외활동·서포터즈 / 채용·인턴' 세 분야는 특히 자세히, 5~7줄로 쓴다:\n"
        "  · 공모전·대회: 주최/주관, 주제·공모분야, 참가 자격(개인/팀·학년), 시상 규모(상금·혜택), "
        "제출물, 접수·발표 일정, (있으면) 심사기준.\n"
        "  · 대외활동·서포터즈: 주최, 활동 내용/미션, 모집 대상·인원, 활동 기간, "
        "혜택(활동비·수료증·우수활동자 혜택), 활동 방식(온/오프라인·주 N회), 지원 방법.\n"
        "  · 채용·인턴: 회사/기관, 모집 직무, 자격 요건, 근무 형태(인턴 기간·근무지·급여), "
        "우대 사항, 전형 절차, 지원 마감.\n"
