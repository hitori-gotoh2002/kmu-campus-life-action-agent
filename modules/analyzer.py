...
def _llm_analyze(notice, parsed_doc, ctx: dict) -> AnalysisResult:
    ...
    sys_prompt = (
        ...
        "[관련성 is_relevant 판단]\n"
        "- true: 학생이 '직접 참여'해 진로/스펙/졸업요건에 도움 되는 활동 "
        "(공모전·경진대회·해커톤·대외활동·서포터즈·기자단·관련 자격증·전공 계절학기 등).\n"
        "- false: 직원/계약직/연구원 '채용·모집 공고', 행정 안내(수강신청·등록·성적정정·"
        "수업평가·기숙사 등), 학생이 참여 주체가 아닌 공지는 모두 false.\n"
        ...
        "- 기본: 공모전·경진대회 30, 해커톤 20, 대외활동·서포터즈(기간형) 35, 자격증 50, 계절학기 45.\n"
